...
internal class CompanyIncomeStatement
{
    ...
    [ColumnWithKey("research_development", Order = 6, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? ResearchDevelopment { get; }

    [ColumnWithKey("effect_of_accounting_charges", Order = 7, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? EffectOfAccountingCharges { get; }

    [ColumnWithKey("income_before_tax", Order = 8, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? IncomeBeforeTax { get; }

    [ColumnWithKey("minority_interest", Order = 9, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? MinorityInterest { get; }

    [ColumnWithKey("net_income", Order = 10, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? NetIncome { get; }

    [ColumnWithKey("selling_general_administrative", Order = 11, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? SellingGeneralAdministrative { get; }

    [ColumnWithKey("selling_and_marketing_expenses", Order = 12, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? SellingAndMarketingExpenses { get; }

    [ColumnWithKey("gross_profit", Order = 13, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? GrossProfit { get; }

    [ColumnWithKey("reconciled_depreciation", Order = 14, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? ReconciledDepreciation { get; }

    [ColumnWithKey("ebit", Order = 15, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? Ebit { get; }

    [ColumnWithKey("ebitda", Order = 16, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? Ebitda { get; }

    [ColumnWithKey("depreciation_and_amortization", Order = 17, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? DepreciationAndAmortization { get; }

    [ColumnWithKey("non_operating_income_net_other", Order = 18, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? NonOperatingIncomeNetOther { get; }

    [ColumnWithKey("operating_income", Order = 19, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? OperatingIncome { get; }

    [ColumnWithKey("other_operating_expenses", Order = 20, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? OtherOperatingExpenses { get; }

    [ColumnWithKey("interest_expense", Order = 21, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? InterestExpense { get; }

    [ColumnWithKey("tax_provision", Order = 22, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? TaxProvision { get; }

    [ColumnWithKey("interest_income", Order = 23, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? InterestIncome { get; }

    [ColumnWithKey("net_interest_income", Order = 24, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? NetInterestIncome { get; }

    [ColumnWithKey("extraordinary_items", Order = 25, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? ExtraordinaryItems { get; }

    [ColumnWithKey("non_recurring", Order = 26, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? NonRecurring { get; }

    [ColumnWithKey("other_items", Order = 27, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? OtherItems { get; }

    [ColumnWithKey("income_tax_expense", Order = 28, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? IncomeTaxExpense { get; }

    [ColumnWithKey("total_revenue", Order = 29, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? TotalRevenue { get; }

    [ColumnWithKey("total_operating_expenses", Order = 30, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? TotalOperatingExpenses { get; }

    [ColumnWithKey("cost_of_revenue", Order = 31, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? CostOfRevenue { get; }

    [ColumnWithKey("total_other_income_expense_net", Order = 32, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? TotalOtherIncomeExpenseNet { get; }

    [ColumnWithKey("discontinued_operations", Order = 33, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? DiscontinuedOperations { get; }

    [ColumnWithKey("net_income_from_continuing_ops", Order = 34, TypeName = "numeric", IsPartOfKey = false)]
    public decimal? NetIncomeFromContinuingOps { get; }

    [ColumnWithKey("net_income_applicable_to_common_shares", Order = 35, TypeName = "numeric", IsPartOfKey = false)]
